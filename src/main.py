...
############################################################
    ...
    if chplot == "all":
        ...
        fig2u1.update_layout(height=900, width=1100, title_text='Autocorrelation comparison Streamwise u1', font=font,  legend=dict(yanchor="bottom", xanchor="left"))
        ...
        fig2u2.update_layout(height=900, width=1100, title_text='Autocorrelation comparison Streamwise u2', font=font,  legend=dict(yanchor="bottom", xanchor="left"))
        ...
        fig2u3.update_layout(height=900, width=1100, title_text='Autocorrelation comparison Streamwise u3', font=font,  legend=dict(yanchor="bottom", xanchor="left"))
    ...
    for ind, zplan in enumerate(zp_ind):
        ...
        omega, k, _, phi11_exp = frozen_turbulence(datas_u1, ind, zp, nt, split_time, dt, n1, dx=dx, ch="spectra", scaling='density')
            
        del datas_u1
        
        von_karman_plot(fig_vanK, col, row, k, phi11_exp, name = '$\phi_{11}exp$', color = 'firebrick', symbols='x')
        ...
        omega, k, _, phi22_exp = frozen_turbulence(datas_u2, ind, zp, nt, split_time, dt, n1, dx=dx, ch="spectra", scaling='density')
        
        del datas_u2
                
        von_karman_plot(fig_vanK, col, row, k, phi22_exp, name = '$\phi_{22}exp$', color = 'midnightblue', symbols='x')
        ...
        omega, k, _, phi33_exp = frozen_turbulence(datas_u3, ind, zp, nt, split_time, dt, n1, dx=dx, ch="spectra", scaling='density')
        
        del datas_u3
        
        von_karman_plot(fig_vanK, col, row, k, phi33_exp, name = '$\phi_{33}exp$', color = 'darkgreen', symbols='x')
    ...
    for ind, zplan in enumerate(zp_ind):
        ...
        von_karman_plot(fig_vanK, col, row, kx, phi11, name = '$\phi^{1}_{11}\\text{VK}$', color = 'firebrick', symbols='circle-open')
        von_karman_plot(fig_vanK, col, row, kx, phi22, name = '$\phi^{1}_{22}\\text{VK}$', color = 'midnightblue', symbols='circle-open')
        von_karman_plot(fig_vanK, col, row, kx, phi33, name = '$\phi^{1}_{33}\\text{VK}$', color = 'darkgreen', symbols='circle-open')
