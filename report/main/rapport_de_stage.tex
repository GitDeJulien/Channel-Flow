\documentclass[12pt]{article}   % TeX Gyre Schola as the main font
...
\vspace{0.1cm}
	...
	Le modèle utilisé par von Kármán provient de l'expression du spectre d'énergie (\refeq{energie_spectra}) sous l'hypothèse que la turbulence est isotropique \cite{wilson1998turbulence},
